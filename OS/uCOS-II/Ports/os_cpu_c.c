...
//void  OS_CPU_SysTickHandler (void)	//we have placed this function to SysTickHandle in stm32f10x_it.c
//{										//to keep consistency,and we can comment these lines out here
   // OS_CPU_SR  cpu_sr;
...
//void  OS_CPU_SysTickInit (void)	//we have configured SysTick in SysTick_Config(void)
//{									//so we can comment these lines out 
  //  INT32U  cnts;
